...
/*
     ...
     <div className="Glucide-filter">
          <label>Glucide: <span style={{color: "#CECECE", fontWeight:"regular", fontSize: "15px"}}>{`De ${GlucideInterval[0]} à ${GlucideInterval[1]} Kcal`}</span></label>           <div className='Glucide-filter1'>
            <h4>De:</h4>
          <input
            type="number"
            min="0"
     ...
     <div className="Tempscuissant-filter">
          <label>Temps de cuissant: <span style={{color: "#CECECE", fontWeight:"regular", fontSize: "15px"}}>{`De ${TempsdecuissantInterval[0]} à ${TempsdecuissantInterval[1]} Kcal`}</span></label>           <div className='Tempscuissant-filter1'>
            <h4>De:</h4>
          <input
            type="number"
            min="0"
     ...
     <div className="Lipides-filter">
          <label>Lipides: <span style={{color: "#CECECE", fontWeight:"regular", fontSize: "15px"}}>{`De ${LipidesInterval[0]} à ${LipidesInterval[1]} Kcal`}</span></label>           <div className='Lipides-filter1'>
            <h4>De:</h4>
          <input
            type="number"
            min="0"
